...
from rl_components.my_spatial_softmax import SpatialSoftArgmax
...
class A2CBuilder(NetworkBuilder):
    ...
    class Network(NetworkBuilder.BaseNetwork):
        def __init__(self, params, **kwargs):
            ...
            if "policy" in input_shape:
                input_shape = input_shape["policy"]
        ...
        def forward(self, obs_dict):
            obs = obs_dict['obs'] # obs contains split between policy and (theoretically) critic
            ...
            if self.separate:
                ...
                # why is this not a tensor? or is it?
                #print(obs)
                if type(obs) is dict:
                    if 'policy' in obs:
                        out = obs['policy']
...
class A2CResnetBuilder(NetworkBuilder):
    ...
    class Network(NetworkBuilder.BaseNetwork):
        def __init__(self, params, **kwargs):
            ...
            print("Building network: mlp_args")
