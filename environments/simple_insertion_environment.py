...
class SimpleInsertion(gym.Env):
    ...
    def set_up_spaces(self):
        ...
        obs_dim = 9 # 9 observation dimensions per robot - pure pose info: 3x translation, 6x rotation
    ...
    def get_RL_state(self, update_msg):
        ...
        obs = np.concatenate(rstate_vecs) #really only need to concat when doing multiple robot control
        return {"policy": obs}
