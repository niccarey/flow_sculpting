...
class BoltEyeConfig():
    ...
    FixedPlatformAsset: str = os.path.join(ROOT_DIR, "stewart_platform/simple_bolt_insert.usd")
    ...
    BallOffset = ([0.0025, 0.145, 0.414], [0.7071068, 0, 0,0.7071068])
    ...
    PlatformBoltOffset = ([[0.0025, 0.165, 0.43],  [0.7071068, 0, 0,0.7071068]])
    ...
    BoltStartPose = pbu.multiply(BoltGoalPose, ([0, 0, -0.02], [0, 0, 0, 1])) 
