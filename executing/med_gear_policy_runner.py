...
from rl_games.common import env_configurations, vecenv # check rl games env requirements
...
config_name = "./med_gear_insertion_config.yaml" # Configuration file for the runner network, and shared context info
...
# CHANGES TO MODELS - something is hanging over from previous arrangement.
# Training now uses my_players, my a2c_continuous instead of my_player, my_agent
# we shouldn't need an isaac environment to run any of this, but somethign is wrong in the ppo player set up
# and the only major change is including isaac components in the observer network structure
